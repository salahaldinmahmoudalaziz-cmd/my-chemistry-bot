...
# ----------------- الإعدادات الأساسية -----------------
# تم تصحيح هذا السطر ليقرأ التوكن من منصة Render بنجاح
BOT_TOKEN = os.environ.get('8504051379:AAFOuehQW8aLFWalGIdGMcj0eJmJKyjdt5M') 
ADMIN_ID = 8333172705

bot = Bot(token=BOT_TOKEN)
dp = Dispatcher()

CATEGORIES = ["كيمياء عضوية", "تحليلية 1", "تحليلية 2", "تحليل آلي", "تقارير مختبرات", "كيمياء فيزيائية"]
pending_files = {}
...
# تم إعادة السطر المفقود هنا لكي تعمل الأزرار
